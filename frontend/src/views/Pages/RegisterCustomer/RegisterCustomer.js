...
export default class RegisterCustomer extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('/customerregister', userObject,
        {crossDomain: true},
        ...
        {mode: 'no-cors'},
          {
            ...
            .then((res) => {
                ...
                if(res.data.result === "Customer Registration Successful"){(
                            ...
                            <Form onSubmit={this.onSubmit}>
                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    <Input placeholder="Occupation" type="select" value={this.state.occupation} name="select" id="exampleSelect" autoComplete="occupation" onChange={this.onChangeOccupation}>
                                        ...
                                        <option disabled>Lab Engineer</option>
                                        <option disabled>Manufacturer</option>
                                        <option disabled>Vendor</option>
                                        <option disabled>Pharmicist</option>
                                    </Input>
                                </InputGroup>
